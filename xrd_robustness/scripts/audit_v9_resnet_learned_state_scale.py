#!/usr/bin/env python3
"""ResNet learned-state, Train-only audit of V9 auxiliary-objective signal.
...
def run_audit(
    *,
    ...
    return {
        "schema_version": "v9-resnet-learned-state-scale-audit-v1",
...
def main() -> int:
    ...
    parser.add_argument(
        "--output",
        default=str(
            PROJECT_ROOT / "reports" / "v9_resnet_learned_state_scale_audit.json"
        ),
    )
