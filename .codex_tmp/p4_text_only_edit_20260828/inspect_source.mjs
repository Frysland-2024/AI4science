...
async function main() {
  ...
  await fs.writeFile(path.join(tmpDir, "source-inspect.ndjson"), snapshot.ndjson, "utf8");
  ...
  await fs.writeFile(path.join(tmpDir, "source-structure.txt"), JSON.stringify(structure, null, 2), "utf8");
}
